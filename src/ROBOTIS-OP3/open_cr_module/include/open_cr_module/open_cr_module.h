...
#include <std_msgs/msg/float32.hpp> // tambahan
...
#include "my_msg/msg/arus.hpp"
#include "my_msg/msg/volt.hpp"
...
private:
  ...
  rclcpp::Publisher<std_msgs::msg::Float32>::SharedPtr battery_volt_pub_; //  tambahan
  rclcpp::Publisher<my_msg::msg::Arus>::SharedPtr arus_pub_;
  rclcpp::Publisher<my_msg::msg::Volt>::SharedPtr volt_pub_;
